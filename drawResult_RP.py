...
folder_path = 'Result/compare'
for index in range(1,3):
	numberOfTag = 50 * index
	folder_Name = "1000_{}_30".format(numberOfTag)

	file_path = folder_path + '/' + folder_Name + '/compare_Rank.txt'
	...
	file_path = folder_path + '/' + folder_Name + '/compare_Prediction.txt'
	open_file = open(file_path, "r")
	x_prediction = []
	y_prediction = []
	for line in open_file:
	...
	pic_filePath = outputFolder_path + '/compare_' + str(numberOfTag) + '.png'
